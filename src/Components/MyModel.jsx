...
const MyModelComponent = () => {
    ...
    const fetchAnnotations = useCallback(() => {
        fetch(`https://handbook-graceless-sheath.ngrok-free.dev/api/annotazioni/?modello=${modelId}`)
            .then((res) => res.json())
            .then(setAnnotations)
    ...
    useEffect(() => {
        fetch(`https://handbook-graceless-sheath.ngrok-free.dev/api/modelli/${modelId}/`)
